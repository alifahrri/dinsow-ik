...
void protobuf_AssignDesc_message_2eproto() {
  ...
  static const int Target_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Target, x_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Target, y_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Target, z_),
  };
  Target_reflection_ =
...
void protobuf_AddDesc_message_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rmessage.proto\022\tdinsow_ik\")\n\006Target\022\t\n\001"
    "x\030\001 \002(\002\022\t\n\001y\030\002 \002(\002\022\t\n\001z\030\003 \002(\002", 69);
...
#ifndef _MSC_VER
const int Target::kXFieldNumber;
const int Target::kYFieldNumber;
const int Target::kZFieldNumber;
#endif  // !_MSC_VER

Target::Target()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:dinsow_ik.Target)
}
...
Target::Target(const Target& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:dinsow_ik.Target)
}
...
Target::~Target() {
  // @@protoc_insertion_point(destructor:dinsow_ik.Target)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:dinsow_ik.Target)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:dinsow_ik.Target)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:dinsow_ik.Target)
  return false;
#undef DO_
}
...
void Target::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:dinsow_ik.Target)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_end:dinsow_ik.Target)
}

::google::protobuf::uint8* Target::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:dinsow_ik.Target)
  // required float x = 1;
  if (has_x()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dinsow_ik.Target)
  return target;
}
